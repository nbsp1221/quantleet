...
class CCXTBackend:
    ...
    This backend exists to keep CCXT-specific constructor and parameter rules
    out of the public Exchange facade.
    """
    ...
    def fetch_ohlcv(
        ...
        *,
        ...
        # ccxt is an untyped boundary in this project, so the cast is kept
        # inside the backend instead of leaking protocol shims into the facade.
        return cast(
            list[list[float]],
