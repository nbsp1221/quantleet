...
| [`data-ingestion.md`](data-ingestion.md) | implemented | yes | current implemented scope | Before changing the shipped historical ingestion surface under `quantcraft.data` for exchange, CSV, and dataframe-backed backtest workflows. | Canonical current implemented-scope spec for research-oriented historical data ingestion. |
