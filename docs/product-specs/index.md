...
| Backtest result plotting | [`backtest-plotting.md`](backtest-plotting.md) | Governing | first-beta target, not yet implemented | Before changing the first-beta plot API, plot implementation, plot dependency strategy, or documented result-visualization workflow. |
| Backtest plotting test scenarios | [`backtest-plotting-test-scenarios.md`](backtest-plotting-test-scenarios.md) | Governing | first-beta test target, not yet implemented | Before writing or reviewing tests for the first-beta result plotting workflow. |
